...
**First release candidate** for the 0.3.1 line (SemVer pre-release `0.3.1-rc1`). **Superseded by `0.3.1-rc2`** after B18 (installer health / Schema 4 mismatch on fresh install).
