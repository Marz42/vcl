...
设计规格与路线图。**实现版本戳以代码为准**（当前开发分支：Controller `0.5.0` · Node `0.5.0`；稳定主线仍为 Controller `0.4.5` · Node `0.3.2`，直到 0.5.0 验收与合并完成）。

| 文件 | 角色 |
| --- | --- |
| [`V0.4.5_Spec.md`](V0.4.5_Spec.md) | 0.4.5 稳定主线规格（Integration + Legacy seed） |
| [`V0.5.0_Spec.md`](V0.5.0_Spec.md) | **当前开发规格**（G0 已冻结；G4/G5 现场验收待完成） |
...
| [`V0.2.7-V0.3.1_spec.md`](V0.2.7-V0.3.1_spec.md) | 节点线历史规格 |
| [`V0.2.5-V0.2.6_dev_spec.md`](V0.2.5-V0.2.6_dev_spec.md) | 更早开发规格 |
