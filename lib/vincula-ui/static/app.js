...
(function () {
  ...
  async function loadOverview() {
    ...
    if ((data.node_count || 0) === 0) {
      $("#users-summary").innerHTML =
        `<p class="empty">No nodes yet. Use <code>node adopt</code> (installed) or <code>node provision</code> (fresh VPS).</p>`;
    } else {
      try {
  ...
  async function loadHealth() {
    ...
    renderWarnings(data.warnings);
    renderWorkspaceStrip($("#health-workspace-strip"), data.workspace);
