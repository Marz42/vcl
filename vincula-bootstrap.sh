...
#
# Usage:
#   RELEASE_URL=https://example.com/vincula-node-0.3.0.tar.gz bash vincula-bootstrap.sh
#
...
# EMBEDDED_RELEASE_URL="https://example.com/releases/vincula-node-0.3.0.tar.gz"
